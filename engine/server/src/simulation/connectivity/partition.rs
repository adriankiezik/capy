...
#[derive(Debug)]
pub(in crate::simulation) struct Metrics {
    pub(in crate::simulation) min: IVec3,
    pub(in crate::simulation) max: IVec3,
    pub(in crate::simulation) mass: f64,
    pub(in crate::simulation) bottom: Vec<u16>,
}
