...
pub struct RendererSettings {
    ...
    pub trace_minimal_outputs: bool,
    pub trace_stats_enabled: bool,
    /// Coarse pre-pass (1 ray per 8x8 tile) that gives primary rays a
    /// conservative start distance, skipping the empty-space march.
...
impl Default for RendererSettings {
    fn default() -> Self {
        Self {
            ...
            max_chunk_steps: 64,
            max_node_steps: 512,
            trace_minimal_outputs: false,
            trace_stats_enabled: false,
            beam_enabled: true,
